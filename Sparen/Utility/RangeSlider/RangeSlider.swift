...
@IBDesignable open class RangeSlider: UIControl {
    ...
    public convenience init(frame: CGRect = .zero, completion: ((RangeSlider) -> Void)? = nil) {
    ...
    @IBInspectable open var minValue: CGFloat = 1000.0 {
        didSet {
            refresh()
        }
    }
    ...
    @IBInspectable open var maxValue: CGFloat = 5000.0 {
        didSet {
            refresh()
        }
    }
    ...
    private func setup() {
        ...
        leftHandle.shadowColor = UIColor(white: 0.2, alpha: 0.8).cgColor
        leftHandle.shadowOpacity = 0.5
        leftHandle.shadowRadius = 2.0
        leftHandle.shadowOffset = CGSize(width: 0.0, height: 2.0)
        ...
        rightHandle.shadowColor = UIColor(white: 0.2, alpha: 0.8).cgColor
        rightHandle.shadowOpacity = 0.5
        rightHandle.shadowRadius = 2.0
        rightHandle.shadowOffset = CGSize(width: 0.0, height: 2.0)
