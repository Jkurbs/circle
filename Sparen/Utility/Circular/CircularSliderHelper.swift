...
internal struct Arc {
    ...
    var cercle = Cercle(origin: CGPoint.zero, radius: 0)
    var startAngle: CGFloat = 0.0
    var endAngle: CGFloat = 0.0
    
    init(cercle: Cercle, startAngle: CGFloat, endAngle: CGFloat) {
...
internal class CircularSliderHelper {
     ...
     */
    internal static func endPoint(fromCircle circle: Cercle, angle: CGFloat) -> CGPoint {
        /*
